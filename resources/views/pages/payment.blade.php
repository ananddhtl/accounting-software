            ...
            <div class="table-heading">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="recepit-img">
                                <a target="_blank" href="{{asset('accounting-software/resources/images/bank-receipt.png')}}"> <img src="{{asset('accounting-software/resources/images/bank-receipt.png')}}" alt=""></a>
                            </div>
                        </td>
                        <td><button class="edit-button">Edit <i class="ri-pencil-line"></i> </button> <button class="del-button">Del <i class="ri-chat-delete-line"></i> </button></td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="recepit-img">
                                <a target="_blank" href="{{asset('accounting-software/resources/images/cash-recipt.png')}}"> <img src="{{asset('accounting-software/resources/images/cash-recipt.png')}}" alt=""></a>
                            </div>
                        </td>
